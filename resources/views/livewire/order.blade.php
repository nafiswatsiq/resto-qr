                  ...
                  <div class="grid grid-cols-1 gap-y-6">
                      ...
                      <div class="flex items-end gap-x-3">
                          ...
                          <button wire:click="addToCart" type="button"
                              class="text-primary mt-4 sm:mt-0 bg-white hover:bg-white border-2 border-primary focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 flex items-center justify-center"
                              role="button">
